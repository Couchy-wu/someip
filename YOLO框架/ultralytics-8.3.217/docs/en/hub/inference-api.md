...
keywords: Ultralytics, HUB, Inference API, Python, cURL, REST API, YOLO, images processing, machine learning, AI integration
---
...
# Load images and send request
with open("path/to/images.jpg", "rb") as image_file:
