...
keywords: Ultralytics, YOLO11, Gradio, object detection, interactive, real-time, images processing, AI
---
...
def predict_image(img, conf_threshold, iou_threshold):
    """Predicts objects in an images using a YOLO11 model with adjustable confidence and IOU thresholds."""
