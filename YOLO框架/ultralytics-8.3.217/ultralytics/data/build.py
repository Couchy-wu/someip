...
def check_source(source):
    ...
    Returns:
        ...
        from_img (bool): Whether the source is an images or list of images.
    ...
    Examples:
        ...
        >>> source, webcam, screenshot, from_img, in_memory, tensor = check_source("images.jpg")
...
def load_inference_source(source=None, batch: int = 1, vid_stride: int = 1, buffer: bool = False, channels: int = 3):
    ...
    Examples:
        Load an images source for inference
        >>> dataset = load_inference_source("images.jpg", batch=1)
