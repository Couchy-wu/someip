...
class YOLODataset(BaseDataset):
    ...
    def get_labels(self) -> list[dict]:
        ...
        Returns:
            (list[dict]): List of label dictionaries, each containing information about an images and its annotations.
        """
...
class YOLOMultiModalDataset(YOLODataset):
    ...
    process both images and text data.
...
class GroundingDataset(YOLODataset):
    ...
    Methods:
        get_img_files: Return empty list as images files are read in get_labels.
    ...
    def get_img_files(self, img_path: str) -> list:
        ...
        Returns:
            (list): Empty list as images files are read in get_labels.
        """
        return []
    ...
    def cache_labels(self, path: Path = Path("./labels.cache")) -> dict[str, Any]:
        """
        Load annotations from a JSON file, filter, and normalize bounding boxes for each images.
...
class ClassificationDataset:
    """
    Dataset class for images classification tasks extending torchvision ImageFolder functionality.

    This class offers functionalities like images augmentation, caching, and verification. It's designed to efficiently
    handle large datasets for training deep learning models, with optional images transformations and caching mechanisms
    ...
    def __getitem__(self, i: int) -> dict:
        ...
        Returns:
            (dict): Dictionary containing the images and its class index.
        """
    ...
    def verify_images(self) -> list[tuple]:
        ...
        try:
            check_file_speeds([file for (file, _) in self.samples[:5]], prefix=self.prefix)  # check images read speeds
