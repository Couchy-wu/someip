...
class LoadStreams:
    ...
    Attributes:
        ...
        cv2_flag (int): OpenCV flag for images reading (grayscale or RGB).
    ...
    def __init__(self, sources: str = "file.streams", vid_stride: int = 1, buffer: bool = False, channels: int = 3):
        ...
        Args:
            ...
            vid_stride (int): Video frame-rate stride.
            buffer (bool): Whether to buffer input streams.
            channels (int): Number of images channels (1 for grayscale, 3 for RGB).
        """
    ...
    def __iter__(self):
        """Iterate through YOLO images feed and re-open unresponsive streams."""
        self.count = -1
        return self
...
class LoadScreenshots:
    ...
    def __iter__(self):
        """Yield the next screenshot images from the specified screen or region for processing."""
        return self
...
class LoadImagesAndVideos:
    ...
    def __iter__(self):
        """Iterate through images/video files, yielding source paths, images, and metadata."""
        self.count = 0
        return self
...
class LoadPilAndNumpy:
    ...
    def __init__(self, im0: Image.Image | np.ndarray | list, channels: int = 3):
        ...
        Args:
            im0 (PIL.Image.Image | np.ndarray | list): Single images or list of images in PIL or numpy format.
            channels (int): Number of images channels (1 for grayscale, 3 for RGB).
        """
...
class LoadTensor:
    ...
    def _single_check(im: torch.Tensor, stride: int = 32) -> torch.Tensor:
        """Validate and format a single images tensor, ensuring correct shape and normalization."""
        s = (
    ...
    def __iter__(self):
        """Yield an iterator object for iterating through tensor images data."""
        self.count = 0
        return self
