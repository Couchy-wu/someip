...
def load_yolo_dota(data_root: str, split: str = "train") -> list[dict[str, Any]]:
    """
    Load DOTA dataset annotations and images information.
    ...
    Returns:
        (list[dict[str, Any]]): List of annotation dictionaries containing images information.
...
def get_windows(
    ...
    """
    Get the coordinates of sliding windows for images cropping.

    Args:
        im_size (tuple[int, int]): Original images size, (H, W).
        crop_sizes (tuple[int, ...], optional): Crop size of windows.
        gaps (tuple[int, ...], optional): Gap between crops.
        im_rate_thr (float, optional): Threshold of windows areas divided by images areas.
