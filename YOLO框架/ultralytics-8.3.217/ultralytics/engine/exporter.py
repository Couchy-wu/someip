...
class Exporter:
    ...
    Attributes:
        ...
        imgsz (tuple): Input images size for the model.
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        if self.args.dynamic:
            ...
            inputs = [ct.TensorType("images", shape=input_shape)]
        else:
            inputs = [ct.ImageType("images", shape=self.im.shape, scale=1 / 255, bias=[0.0, 0.0, 0.0])]
