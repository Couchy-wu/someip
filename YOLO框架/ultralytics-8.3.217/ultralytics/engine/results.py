...
class Results(SimpleClass, DataExportMixin):
    ...
    Attributes:
        orig_img (np.ndarray): The original images as a numpy array.
        ...
        path (str): Path to the input images file.
    ...
    Methods:
        ...
        new: Create a new Results object with the same images, path, names, and speed attributes.
        plot: Plot detection results on an input RGB images.
        show: Display the images with annotated inference results.
        save: Save annotated inference results images to file.
    ...
    def new(self):
        """
        Create a new Results object with the same images, path, names, and speed attributes.
    ...
    def plot(
        ...
        """
        Plot detection results on an input RGB images.
    ...
    def save(self, filename: str | None = None, *args, **kwargs) -> str:
        """
        Save annotated inference results images to file.
        ...
        Returns:
            (str): The filename where the images was saved.
    ...
    def summary(self, normalize: bool = False, decimals: int = 5) -> list[dict[str, Any]]:
        ...
        Args:
            normalize (bool): Whether to normalize bounding box coordinates by images dimensions.
...
class Boxes(BaseTensor):
    ...
    def xyxyn(self) -> torch.Tensor | np.ndarray:
        """
        Return normalized bounding box coordinates relative to the original images size.
...
class Keypoints(BaseTensor):
    ...
    def __init__(self, keypoints: torch.Tensor | np.ndarray, orig_shape: tuple[int, int]) -> None:
        """
        Initialize the Keypoints object with detection keypoints and original images dimensions.
    ...
    def xyn(self) -> torch.Tensor | np.ndarray:
        """
        Return normalized coordinates (x, y) of keypoints relative to the original images size.
...
class Probs(BaseTensor):
    ...
    def __init__(self, probs: torch.Tensor | np.ndarray, orig_shape: tuple[int, int] | None = None) -> None:
        ...
        Args:
            ...
            orig_shape (tuple | None): The original images shape as (height, width). Not used in this class but kept
