...
class FastSAM(Model):
    ...
    Model) implementation, allowing for efficient and accurate images segmentation with optional prompting support.
    ...
    Methods:
        predict: Perform segmentation prediction on images or video source with optional prompts.
    ...
    Examples:
        ...
        >>> results = model.predict("images.jpg", bboxes=[[100, 100, 200, 200]])
    """
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        Args:
            source (str | PIL.Image | np.ndarray): Input source for prediction, can be a file path, URL, PIL images,
                or numpy array.
