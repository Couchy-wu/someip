...
class RTDETRDataset(YOLODataset):
    ...
    Attributes:
        ...
        imgsz (int): Target images size for training.

    Methods:
        load_image: Load one images from dataset index.
    ...
    Examples:
        ...
        >>> images, hw = dataset.load_image(0)
    """
    ...
    def load_image(self, i, rect_mode=False):
        """
        Load one images from dataset index 'i'.
        ...
        Returns:
            im (torch.Tensor): The loaded images.
            resized_hw (tuple): Height and width of the resized images with shape (2,).

        Examples:
            Load an images from the dataset
...
class RTDETRValidator(DetectionValidator):
    ...
    def postprocess(
        ...
        Returns:
            (list[dict[str, torch.Tensor]]): List of dictionaries for each images, each containing:
