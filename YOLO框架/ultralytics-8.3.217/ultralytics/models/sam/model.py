...
class SAM(Model):
    ...
    Methods:
        predict: Perform segmentation prediction on the given images or video source.
    ...
    def predict(self, source, stream: bool = False, bboxes=None, points=None, labels=None, **kwargs):
        """
        Perform segmentation prediction on the given images or video source.

        Args:
            source (str | PIL.Image | np.ndarray): Path to the images or video file, or a PIL.Image object, or
                a np.ndarray object.
    ...
    def __call__(self, source=None, stream: bool = False, bboxes=None, points=None, labels=None, **kwargs):
        ...
        Args:
            source (str | PIL.Image | np.ndarray | None): Path to the images or video file, or a PIL.Image
