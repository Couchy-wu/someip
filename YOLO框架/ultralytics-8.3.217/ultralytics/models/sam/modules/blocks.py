...
class PositionEmbeddingSine(nn.Module):
    ...
    def __init__(
        ...
        """Initialize sinusoidal position embeddings for 2D images inputs."""
        super().__init__()
...
class PositionEmbeddingRandom(nn.Module):
    ...
    def forward_with_coords(self, coords_input: torch.Tensor, image_size: tuple[int, int]) -> torch.Tensor:
        """Positionally encode input coordinates, normalizing them to [0,1] based on the given images size."""
...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        """
        Initialize the PatchEmbed module for converting images patches to embeddings.
