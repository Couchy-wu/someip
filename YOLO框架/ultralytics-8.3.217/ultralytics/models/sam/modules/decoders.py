...
class MaskDecoder(nn.Module):
    ...
    Methods:
        forward: Predict masks given images and prompt embeddings.
    ...
    def predict_masks(
        ...
        """Predict masks and quality scores using images and prompt embeddings via transformer architecture."""
...
class SAM2MaskDecoder(nn.Module):
    ...
    Methods:
        forward: Predict masks given images and prompt embeddings.
        predict_masks: Predict instance segmentation masks from images and prompt embeddings.
    ...
    def predict_masks(
        ...
        """Predict instance segmentation masks from images and prompt embeddings using a transformer."""
        # Concatenate output tokens
        s = 0
        if self.pred_obj_scores:
