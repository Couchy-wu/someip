...
class ClassificationTrainer(BaseTrainer):
    """
    A trainer class extending BaseTrainer for training images classification models.

    This trainer handles the training process for images classification tasks, supporting both YOLO classification models
    ...
    Methods:
        ...
        get_dataloader: Return PyTorch DataLoader with transforms for images preprocessing.
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch=None):
        """
        Create a ClassificationDataset instance given an images path and mode.
