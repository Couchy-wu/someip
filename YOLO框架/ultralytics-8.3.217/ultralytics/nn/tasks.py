...
class BaseModel(torch.nn.Module):
    ...
    def predict(self, x, profile=False, visualize=False, augment=False, embed=None):
        ...
        Args:
            ...
            augment (bool): Augment images during prediction.
    ...
    def info(self, detailed=False, verbose=True, imgsz=640):
        ...
        Args:
            ...
            imgsz (int): The size of the images that the model will be trained on.
        """
...
class DetectionModel(BaseModel):
    ...
    def _descale_pred(p, flips, scale, img_size, dim=1):
        ...
        Args:
            ...
            img_size (tuple): Original images size (height, width).
...
class ClassificationModel(BaseModel):
    ...
    This class implements the YOLO classification architecture for images classification tasks,
