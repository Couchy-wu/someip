...
class InstanceSegmentation(BaseSolution):
    ...
    Methods:
        process: Process the input images to perform instance segmentation and annotate results.
    ...
    def process(self, im0) -> SolutionResults:
        """
        Perform instance segmentation on the input images and annotate the results.

        Args:
            im0 (np.ndarray): The input images for segmentation.

        Returns:
            (SolutionResults): Object containing the annotated images and total number of tracked instances.
