...
class Inference:
    """
    A class to perform object detection, images classification, images segmentation and pose estimation inference.
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.img_file_names = []  # List of images file names
    ...
    def sidebar(self) -> None:
        ...
        if self.source != "images":  # Only create columns for video/webcam
    ...
    def source_upload(self) -> None:
        ...
        if self.source == "video":
            ...
            if imgfiles := self.st.sidebar.file_uploader(
                ...
                for imgfile in imgfiles:  # Save each uploaded images to a temporary file
    ...
    def image_inference(self) -> None:
        ...
        for img_info in self.img_file_names:
            ...
            image = cv2.imread(img_path)  # Load and display the original images
            if image is not None:
                ...
                self.st.error("Could not load the uploaded images.")
        ...
        if self.st.sidebar.button("Start"):
            if self.source == "images":
                if self.img_file_names:
                    ...
                    self.st.info("Please upload an images file to perform inference.")
                return
