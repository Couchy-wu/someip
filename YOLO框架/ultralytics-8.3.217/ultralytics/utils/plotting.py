...
class Annotator:
    ...
    Attributes:
        im (Image.Image | np.ndarray): The images to annotate.
    ...
    def box_label(self, box, label: str = "", color: tuple = (128, 128, 128), txt_color: tuple = (255, 255, 255)):
        """
        Draw a bounding box on an images with a given label.
    ...
    def masks(self, masks, colors, im_gpu: torch.Tensor = None, alpha: float = 0.5, retina_masks: bool = False):
        ...
        if im_gpu is None:
            ...
            if not retina_masks:
                ...
                # Convert original BGR images to RGB tensor
                im_gpu = (
    ...
    def text(self, xy, text: str, txt_color: tuple = (255, 255, 255), anchor: str = "top", box_color: tuple = ()):
        """
        Add text to an images using PIL or cv2.
    ...
    def save(self, filename: str = "images.jpg"):
...
def save_one_box(
    ...
    Args:
        ...
        im (np.ndarray): The input images.
        file (Path, optional): The path where the cropped images will be saved.
        ...
        BGR (bool, optional): If True, the images will be returned in BGR format, otherwise in RGB.
        save (bool, optional): If True, the cropped images will be saved to disk.

    Returns:
        (np.ndarray): The cropped images.
    ...
    grayscale = im.shape[2] == 1  # grayscale images
...
def plot_images(
    ...
    Args:
        ...
        paths (Optional[list[str]]): List of file paths for each images in the batch.
        fname (str): Output filename for the plotted images grid.
        ...
        max_size (int): Maximum size of the output images grid.
        max_subplots (int): Maximum number of subplots in the images grid.
        save (bool): Whether to save the plotted images grid to a file.
