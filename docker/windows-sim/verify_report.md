...
**✅ 结果：19 通过 / 0 失败 / 0 跳过**（共 19 项，通过率 100.0%，耗时 43.75s）

- 生成时间: `2026-09-21 14:19:39`
...
- 上次运行: `2026-09-21 14:18:41`（判定 PASS）
- 上次运行: `2026-09-21 14:18:41`（判定 PASS）
- 无变化（与上次逐项一致）
...
| 4 | 4. 界面字体与中文渲染字体 | ✅ PASS | 0.2 | selected='微软雅黑', 可用字体=0, PIL字体=<_io.BytesIO object at 0x00000000012F02C0> |
...
| 7 | 7. main.py 导入链（不启动 GUI 主循环） | ✅ PASS | 1.8 | import main 成功；MainWindow/TextRedirector 可用；导出=3 项 |
...
| 18 | 18. 单元测试（pytest） | ✅ PASS | 22.4 | ................ [100%] |
