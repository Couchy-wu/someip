...
**✅ 结果：19 通过 / 0 失败 / 0 跳过**（共 19 项，通过率 100.0%，耗时 88.48s）

- 生成时间: `2026-09-21 15:37:13`
...
- 上次运行: `2026-09-21 15:33:58`（判定 PASS）
- 上次运行: `2026-09-21 15:33:58`（判定 PASS）
- 无变化（与上次逐项一致）
...
| 17 | 17. 项目自带自检脚本可运行 | ✅ PASS | 12.7 | check_imports.py rc=0 (项目内部导入全部可解析 ✓); check_static.py rc=0 (静态检查通过 ✓); selftest.py rc=0 (============================================================) |
| 18 | 18. 单元测试（pytest） | ✅ PASS | 64.7 | .ss........................................ [100%] |
