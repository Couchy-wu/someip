...
**✅ 结果：19 通过 / 0 失败 / 0 跳过**（共 19 项，通过率 100.0%，耗时 55.69s）

- 生成时间: `2026-09-21 14:33:06`
...
- 上次运行: `2026-09-21 14:31:07`（判定 FAIL）
- 上次运行: `2026-09-21 14:31:07`（判定 FAIL）
- 已修复（1）：`18. 单元测试（pytest）`
...
| 4 | 4. 界面字体与中文渲染字体 | ✅ PASS | 0.2 | selected='微软雅黑', 可用字体=0, PIL字体=<_io.BytesIO object at 0x00000000012F0360> |
...
| 7 | 7. main.py 导入链（不启动 GUI 主循环） | ✅ PASS | 2.3 | import main 成功；MainWindow/TextRedirector 可用；导出=3 项 |
...
| 17 | 17. 项目自带自检脚本可运行 | ✅ PASS | 11.3 | check_imports.py rc=0 (项目内部导入全部可解析 ✓); check_static.py rc=0 (静态检查通过 ✓); selftest.py rc=0 (============================================================) |
| 18 | 18. 单元测试（pytest） | ✅ PASS | 33.0 | -- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html |
