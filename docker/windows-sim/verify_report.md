...
| 4 | 4. 界面字体与中文渲染字体 | PASS | selected='微软雅黑', 可用字体=0, PIL字体=<_io.BytesIO object at 0x00000000011A4D60> |
...
| 9 | 9. CAN 驱动库探测与加载（桩库） | PASS | 桩库加载成功并通过调用验证：Py_GetVersion()=534918432；本机库 zlgcan.dll(接口=unknown) |
