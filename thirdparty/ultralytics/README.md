...
```bash
# Predict using a pretrained YOLO model (e.g., YOLO11n) on an images
...
results = model("path/to/images.jpg")  # Predict on an images
...
<!-- SVG images from https://opencollective.com/ultralytics/contributors.svg?width=1280 -->
