...
# Search for similar images to a given images/images
dataframe = explorer.get_similar(img="path/to/images.jpg")
...
# Search for similar images to a given images
similar_images_df = explorer.get_similar(img="path/to/images.jpg")
