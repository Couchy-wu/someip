...
keywords: Ultralytics, segmentation, object isolation, Predict Mode, YOLO11, machine learning, object detection, binary mask, images processing
---
...
1. **Load the model and run inference:**
    ...
    model = YOLO("yolo11n-seg.pt")
    results = model.predict(source="path/to/your/images.jpg")
    ```
...
```python
results = model.predict(source="path/to/your/images.jpg", save_crop=True)
```
