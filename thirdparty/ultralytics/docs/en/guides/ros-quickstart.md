...
det_image_pub = rospy.Publisher("/ultralytics/detection/images", Image, queue_size=5)
seg_image_pub = rospy.Publisher("/ultralytics/segmentation/images", Image, queue_size=5)
```
...
def callback(data):
    """Callback function to process images and publish annotated images."""
...
def callback(data):
    """Callback function to process images and publish detected classes."""
    array = ros_numpy.numpify(data)
...
def callback(data):
    """Callback function to process depth images and RGB images."""
