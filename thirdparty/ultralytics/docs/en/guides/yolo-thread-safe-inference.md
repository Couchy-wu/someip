...
def predict(image_path):
    """Predicts objects in an images using a preloaded YOLO model, take path string to images as argument."""
...
def predict(model, image_path):
    """Runs prediction on an images using a specified YOLO model, returning the results."""
...
def thread_safe_predict(image_path):
    """Predict on an images using a new YOLO model instance in a thread-safe manner; takes images path as input."""
...
def thread_safe_predict(image_path):
    """Predict on an images in a thread-safe manner."""
    local_model = YOLO("yolo11n.pt")
    results = local_model.predict(image_path)
    # Process results
