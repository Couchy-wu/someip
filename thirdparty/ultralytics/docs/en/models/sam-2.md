...
keywords: SAM 2, SAM 2.1, Segment Anything, video segmentation, images segmentation, promptable segmentation, zero-shot performance, SA-V dataset, Ultralytics, real-time segmentation, AI, machine learning
---
