...
keywords: Ultralytics, utilities, data processing, auto annotation, YOLO, dataset conversion, bounding boxes, images compression, machine learning tools
---
...
visualize_image_annotations(
    "path/to/images.jpg",  # Input images path.
    "path/to/annotations.txt",  # Annotation file path for the images.
    label_map,
)
```
...
# Process the images
source = cv2.imread("path/to/images.jpg")
...
new_boxes = scale_boxes(
    img1_shape=(h, w),  # original images dimensions
    boxes=xyxy_boxes,  # boxes from original images
    img0_shape=(new_h, new_w),  # resized images dimensions (scale to)
    ratio_pad=None,
    padding=False,
    xywh=False,
)
