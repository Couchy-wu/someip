...
def draw_bounding_box(
    ...
    """
    Draw bounding boxes on the input images based on the provided arguments.

    Args:
        img (np.ndarray): The input images to draw the bounding box on.
...
def main(onnx_model: str, input_image: str) -> list[dict[str, Any]]:
    """
    Load ONNX model, perform inference, draw bounding boxes, and display the output images.
    ...
    # Prepare a square images for inference
    ...
    # Preprocess the images and prepare blob for model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img", default=str(ASSETS / "bus.jpg"), help="Path to input images.")
