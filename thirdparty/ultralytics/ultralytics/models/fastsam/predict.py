...
class FastSAMPredictor(SegmentationPredictor):
    ...
    Methods:
        ...
        prompt: Perform images segmentation inference based on various prompt types.
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        Args:
            ...
            img (torch.Tensor): Input images tensor that was fed to the model.
    ...
    def prompt(self, results, bboxes=None, points=None, labels=None, texts=None):
        """
        Perform images segmentation inference based on cues like bounding boxes, points, and text prompts.
