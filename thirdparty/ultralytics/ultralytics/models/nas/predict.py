...
class NASPredictor(DetectionPredictor):
    ...
    def postprocess(self, preds_in, img, orig_imgs):
        ...
        Args:
            ...
            img (torch.Tensor): Input images tensor that was fed to the model, with shape (B, C, H, W).
        ...
        Returns:
            (list): List of Results objects containing the processed predictions for each images in the batch.
