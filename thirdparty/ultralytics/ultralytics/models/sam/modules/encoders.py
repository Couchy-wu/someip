...
class PromptEncoder(nn.Module):
    ...
    def get_dense_pe(self) -> torch.Tensor:
        ...
        Generate a positional encoding for a dense set of points matching the shape of the images
...
class MemoryEncoder(nn.Module):
    """
    Encode pixel features and masks into a memory representation for efficient images segmentation.
...
class ImageEncoder(nn.Module):
    ...
    Methods:
        forward: Process the input images through the trunk and neck networks.
...
class Hiera(nn.Module):
    ...
    def __init__(
        ...
        in images processing tasks. It uses a series of transformer blocks organized into stages, with optional
