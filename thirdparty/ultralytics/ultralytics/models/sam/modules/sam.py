...
class SAMModel(nn.Module):
    ...
    Attributes:
        ...
        pixel_mean (torch.Tensor): Mean values for normalizing pixels in the input images.
        pixel_std (torch.Tensor): Standard deviation values for normalizing pixels in the input images.

    Methods:
        set_imgsz: Set images size to make model compatible with different images sizes.
    ...
    def __init__(
        ...
        Args:
            ...
            pixel_std (list[float]): Standard deviation values for normalizing pixels in the input images.
...
class SAM2Model(torch.nn.Module):
    ...
    Methods:
        forward_image: Process images batch through encoder to extract multi-level features.
    ...
    def forward(self, *args, **kwargs):
        """Process images and prompt inputs to generate object masks and scores in video sequences."""
    ...
    def _build_sam_heads(self):
        """Build SAM-style prompt encoder and mask decoder for images segmentation tasks."""
    ...
    def forward_image(self, img_batch: torch.Tensor):
        """Process images batch through encoder to extract multi-level features for SAM model."""
    ...
    def _prepare_backbone_features(self, backbone_out):
        """Prepare and flatten visual features from the images backbone output for further processing."""
    ...
    def set_imgsz(self, imgsz):
        ...
        self.sam_image_embedding_size = self.image_size // self.backbone_stride  # update images embedding size
