...
class TwoWayTransformer(nn.Module):
    ...
    Methods:
        forward: Process images and point embeddings through the transformer.
    ...
    def forward(
        ...
        """
        Process images and point embeddings through the Two-Way Transformer.
        ...
        Returns:
            ...
            keys (torch.Tensor): Processed images embeddings with shape (B, H*W, embedding_dim).
        """
...
class TwoWayAttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        """
        Initialize a TwoWayAttentionBlock for simultaneous attention to images and query points.
