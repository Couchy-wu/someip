...
class OBBPredictor(DetectionPredictor):
    ...
    def construct_result(self, pred, img, orig_img, img_path):
        ...
        Args:
            ...
            img (torch.Tensor): The images after preprocessing with shape (B, C, H, W).
            orig_img (np.ndarray): The original images before preprocessing.
            img_path (str): The path to the original images.

        Returns:
            (Results): The result object containing the original images, images path, class names, and oriented bounding
                boxes.
        """
