...
class PoseValidator(DetectionValidator):
    ...
    def _prepare_batch(self, si: int, batch: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns:
            (dict[str, Any]): Prepared batch with keypoints scaled to original images dimensions.

        Notes:
            This method extends the parent class's _prepare_batch method by adding keypoint processing.
            Keypoints are scaled from normalized coordinates to original images dimensions.
        """
    ...
    def save_one_txt(self, predn: dict[str, torch.Tensor], save_conf: bool, shape: tuple[int, int], file: Path) -> None:
        ...
        Args:
            ...
            shape (tuple[int, int]): Shape of the original images (height, width).
    ...
    def pred_to_json(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> None:
        ...
        Notes:
            The method extracts the images ID from the filename stem (either as an integer if numeric, or as a string),
    ...
    def scale_preds(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> dict[str, torch.Tensor]:
        """Scales predictions to the original images size."""
        return {
