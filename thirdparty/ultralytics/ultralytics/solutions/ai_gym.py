...
class AIGym(BaseSolution):
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Returns:
            (SolutionResults): Contains processed images `plot_im`,
        ...
        self.display_output(plot_im)  # Display output images, if environment support display
