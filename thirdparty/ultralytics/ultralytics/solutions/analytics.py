...
class Analytics(BaseSolution):
    ...
    Methods:
        process: Process images data and update the chart.
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        figsize = self.CFG["figsize"]  # set output images size i.e (12.8, 7.2) -> w = 1280, h = 720
    ...
    def process(self, im0: np.ndarray, frame_number: int) -> SolutionResults:
        """
        Process images data and run object tracking to update analytics charts.
        ...
        Returns:
            (SolutionResults): Contains processed images `plot_im`, 'total_tracks' (int, total number of tracked objects)
