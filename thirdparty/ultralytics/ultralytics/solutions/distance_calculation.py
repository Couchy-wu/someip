...
class DistanceCalculation(BaseSolution):
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Args:
            im0 (np.ndarray): The input images frame to process.

        Returns:
            (SolutionResults): Contains processed images `plot_im`, `total_tracks` (int) representing the total number
        ...
        # Return SolutionResults with processed images and calculated metrics
