...
class ObjectCounter(BaseSolution):
    ...
    def display_counts(self, plot_im) -> None:
        """
        Display object counts on the input images or frame.

        Args:
            plot_im (np.ndarray): The images or frame to display counts on.
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Args:
            im0 (np.ndarray): The input images or frame to be processed.

        Returns:
            (SolutionResults): Contains processed images `im0`, 'in_count' (int, count of objects entering the region),
