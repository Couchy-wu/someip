...
class ObjectCropper(BaseSolution):
    ...
    Methods:
        process: Crop detected objects from the input images and save them to the output directory.
    ...
    def process(self, im0) -> SolutionResults:
        """
        Crop detected objects from the input images and save them as separate images.
