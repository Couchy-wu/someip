...
class QueueManager(BaseSolution):
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Args:
            im0 (np.ndarray): Input images for processing, typically a frame from a video stream.

        Returns:
            (SolutionResults): Contains processed images `im0`, 'queue_count' (int, number of objects in the queue) and
