...
class VisionEye(BaseSolution):
    ...
    Methods:
        process: Process the input images to detect objects, annotate them, and apply vision mapping.
    ...
    def process(self, im0) -> SolutionResults:
        """
        Perform object detection, vision mapping, and annotation on the input images.

        Args:
            im0 (np.ndarray): The input images for detection and annotation.

        Returns:
            (SolutionResults): Object containing the annotated images and tracking statistics.
                - plot_im: Annotated output images with bounding boxes and vision mapping
        ...
        for cls, t_id, box, conf in zip(self.clss, self.track_ids, self.boxes, self.confs):
            # Annotate the images with bounding boxes, labels, and vision mapping
        ...
        # Return a SolutionResults object with the annotated images and tracking statistics
