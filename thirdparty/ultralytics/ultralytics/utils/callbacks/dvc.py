...
def _log_images(path: Path, prefix: str = "") -> None:
    ...
    functionality in the UI. It processes images filenames to extract batch information and restructures the path
    accordingly.

    Args:
        path (Path): Path to the images file to be logged.
        prefix (str, optional): Optional prefix to add to the images name when logging.
...
def _log_plots(plots: dict, prefix: str = "") -> None:
    ...
    Args:
        ...
        prefix (str, optional): Optional prefix to add to the logged images paths.
    """
