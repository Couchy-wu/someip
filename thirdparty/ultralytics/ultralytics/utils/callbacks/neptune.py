...
def _log_images(imgs_dict: dict, group: str = "") -> None:
    ...
    This function logs images data to Neptune.ai when a valid Neptune run is active. Images are organized
    under the specified group name.

    Args:
        imgs_dict (dict): Dictionary of images to log, with keys as images names and values as images data.
