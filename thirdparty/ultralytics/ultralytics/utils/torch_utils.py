...
def model_info(model, detailed=False, verbose=True, imgsz=640):
    ...
    Args:
        ...
        imgsz (int | list, optional): Input images size.
...
def get_flops(model, imgsz=640):
    ...
    then falls back to full images size if needed (e.g., for RTDETR models). Returns 0.0
    ...
    try:
        ...
        try:
            ...
            # Method 2: Use actual images size (required for RTDETR models)
...
def scale_img(img, ratio=1.0, same_shape=False, gs=32):
    """
    Scale and pad an images tensor, optionally maintaining aspect ratio and padding to gs multiple.
    ...
    Returns:
        (torch.Tensor): Scaled and padded images tensor.
    """
    if ratio == 1.0:
        return img
    h, w = img.shape[2:]
